...
const Sidebar = () => {
  ...
  return (
    <div
      className="h-[96vh] fixed rounded-[30px] p-[2%] bg-black text-white w-[280px]"
      style={styles}
    >
      <h1 className="mt-5 text-4xl ml-5 font-MontserratBold font-extrabold">Board.</h1>
      <div className="mt-12 ml-5 font-Montserrat">
        <div className="flex items-center my-10 mx-0 cursor-pointer transition duration-500">
          <Image
            ...
            alt="Dashboard"
          />
          <p className="text-lg font-MontserratBold font-extrabold">Dashboard</p>
        </div>
        <div className="flex items-center my-10 mx-0 cursor-pointer transition duration-500 ">
          <Image
            src={transactionIcon}
      ...
      <div className="absolute bottom-9 ml-5 text-sm">
        <p className="my-3 cursor-pointer font-Montserrat  transition">Help</p>
        <p className="my-3 cursor-pointer font-Montserrat  transition">
          Contact
        </p>
      </div>
    </div>

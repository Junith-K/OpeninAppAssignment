...
const Form = () => {
  ...
  return (
    <div id="main-div" className="w-[386px]">
      <div className="text-4xl font-Montserrat font-[700] mb-2">Sign In</div>
      <p className="font-Montserrat font-medium">Sign in to your account</p>
      <div id="login-buttons" className="flex justify-between my-5 mx-0">
        <button
          onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
          className="w-[180px] text-[#858585] text-[12px] font-Montserrat tracking-wider justify-center flex items-center px-2 py-2 bg-white border-none rounded-[10px] cursor-pointer  transition duration-500"
        >
          <Image
        ...
        <button className="w-[180px] text-[#858585] text-[12px] font-Montserrat tracking-wider justify-center flex items-center py-2 px-2  bg-white border-none rounded-md cursor-pointer  transition duration-500">
          <Image
      ...
      >
        ...
        <button
          ...
          className="font-Montserrat text-white rounded-[10px] bg-[#4285F4] p-3 text-base font-bold border-none cursor-pointer transition duration-500"
          // style={styles}
        >
          Sign In
        </button>
